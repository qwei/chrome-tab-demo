...
//    MyOverView myOverView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setPageMargin(
                getResources().getDimensionPixelOffset(R.dimen.pager_margin));
        mViewPager.setAdapter(new MyPageAdapter());
//        myOverView = (MyOverView) findViewById(R.id.recents_view);
//        mRecentsView = (Overview) findViewById(R.id.recents_view);
//        mRecentsView.setCallbacks(this);
//        myOverView.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE |
...
//                View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
    ...
    class MyPageAdapter extends PagerAdapter {
        ...
        public void destroyItem(ViewGroup container, int position, Object object) {
            ...
            ((ViewPager)container).removeView((MyOverView) object);
        }

        @Override
        public Object instantiateItem(ViewGroup container, int position) {
            MyOverView overView = new MyOverView(mContext);
            ((ViewPager) container).addView(overView, position);
            return overView;
        }
    }
